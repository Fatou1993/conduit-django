...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    gender = serializers.ChoiceField(choices=['Homme', 'Femme'])
    target = serializers.ChoiceField(choices=['Homme', 'Femme'])

    class Meta:
        model = User
        # List all of the fields that could possibly be included in a request
        # or response, including fields specified explicitly above.
        fields = ["email", "username", "first_name", "last_name", 'phone_number', 'image', 'gender', 'target', 'city', 'birthday', 'is_adult', 'accept_data_treatment', "password", "token"]
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta :
        model = User
        fields = ('email', 'username', "first_name", "last_name", 'phone_number', 'image', 'gender', 'target',
                  'city', 'birthday', 'password', 'token', 'profile', )
